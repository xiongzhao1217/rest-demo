...
(function () {
	...
	var URL = popBerry.context.getBasePath()+'static/common/js/lib/ueditor/';
	...
	window.UEDITOR_CONFIG = {
		...
		, serverUrl: popBerry.context.getBasePath() + "uploader/uEditorUpload"
		...
		// ,imageAllowFiles:['jpg','png']



		,imageActionName: "uploadImage", /* 执行上传图片的action名称 */
		imageFieldName: "uEditorFile", /* 提交的图片表单名称 */
...
//          ]
		...
		//每一个对象就是一个自定义的样式
		,'customstyle':[
			// {tag:'h1', name:'tc', label:'', style:'border-bottom:red 2px solid;padding:0 4px 0 0;text-align:center;margin:0 0 20px 0;'},
			// {tag:'h1', name:'tl',label:'', style:'border-bottom:#ccc 2px solid;padding:0 4px 0 0;margin:0 0 10px 0;'},
			// {tag:'span',name:'im', label:'', style:'font-style:italic;font-weight:bold'},
			{tag:'span',name:'大标题', label:'大标题', style:'color:#333333;font-size:22px;line-height:1;padding:0 0 20px 0;font-family:"黑体"'},
			{tag:'span',name:'标题', label:'标题', style:'color:#84a740;font-size:18px;line-height:1;padding:0 0 10px 0;border-bottom:1px #84a740 solid;display:block;text-align:center;font-family:"黑体"'},
			{tag:'span',name:'小标题', label:'小标题', style:'color:#333333;font-size:16px;line-height:1;padding:0 0 20px 0;font-weight:bold;font-family:"黑体"'},
            {tag:'span',name:'文章来源', label:'文章来源', style:'color:#999999;font-size:14px;line-height:1;padding:0 0 20px 0;font-family:"黑体"'},
            {tag:'span',name:'正文', label:'正文', style:'color:#444444;font-size:16px;line-height:1;padding:0 0 20px 0;font-family:"黑体"'}
		]
