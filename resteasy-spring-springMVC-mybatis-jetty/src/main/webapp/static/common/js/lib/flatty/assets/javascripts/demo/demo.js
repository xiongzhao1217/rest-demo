(function() {
    $(document).ready(function() {
        ...
        if ((localStorage.getItem("contrast") !== null) && !$("body").hasClass("contrast-background")) {
            ...
            //var color = localStorage.getItem("contrast").split('-')[1];
            //var tableClass = "box-header "+color+"-background";
            //$('#tableClass').attr('class',tableClass);
        }
        ...
        return $(".color-settings-contrast-color > a").hover(function() {
            ...
            //var color = $(this).data("change-to").split('-')[1];
            //var tableClass = "box-header "+color+"-background";
            //$('#tableClass').attr('class',tableClass);
